"""
Environment variable setup for thesis.
"""

import cPickle as pickle

def hardCodeSquirrelEnv():
    ...
    # pickle it
    file = open("./squirrelEnv.pkl", "wb")
    pickle.dump(squirrelEnv, file)
    file.close()
...
def hardCodeAsdfEnv():
    ...
    # pickle it
    file = open("./asdfEnv.pkl", "wb")
    pickle.dump(asdfEnv, file)
    file.close()
